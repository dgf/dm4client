(function() {
  ...
  exports.create = function(serverUrl) {
    var associationCreateUrl, associationUrl, getTypeInfos, httpOptions, topicCreateUrl, topicUrl, topicsUrl, typeUrl, typesUrl;
    ...
    getTypeInfos = function(types, onSuccess, onError) {
      ...
      getTypeInfo = function(uri, callback) {
        ...
        return GET(typeUrl(uri), addTypeInfo, onError);
      };
    ...
    return {
      createAssociation: function(association, onSuccess, onError) {
        return POST(associationCreateUrl, association, onSuccess, onError);
      },
      ...
      deleteAssociation: function(id, onSuccess, onError) {
        return DEL(associationUrl(id), onSuccess, onError);
      },
      ...
      getTypes: function(onSuccess, onError) {
        ...
        return GET(typesUrl, getAndDetachInfos, onError);
      },
